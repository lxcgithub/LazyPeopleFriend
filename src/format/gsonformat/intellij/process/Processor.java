...
import format.gsonformat.intellij.common.FieldHelper;
import format.gsonformat.intellij.common.PsiClassUtil;
import format.gsonformat.intellij.common.Try;
import format.gsonformat.intellij.config.Config;
import format.gsonformat.intellij.config.Constant;
import format.gsonformat.intellij.entity.ClassEntity;
import format.gsonformat.intellij.entity.ConvertLibrary;
            ...
            Try.run(new Try.TryListener() {
                ...
                public void runAgain() {
                    cls.addBefore(factory.createCommentFromText(
                    		"// FIXME generate failure  method  set and get " + StringUtils.captureName(finalFieldName), cls), cls.getChildren()[0]);
